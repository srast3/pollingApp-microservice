package com.mycompany.pollingApp.service;
...
import com.mycompany.pollingApp.exception.BadRequestException;
import com.mycompany.pollingApp.exception.ResourceNotFoundException;
import com.mycompany.pollingApp.model.Choice;
import com.mycompany.pollingApp.model.ChoiceVoteCount;
import com.mycompany.pollingApp.model.Poll;
import com.mycompany.pollingApp.model.User;
import com.mycompany.pollingApp.model.Vote;
...
import com.mycompany.pollingApp.util.ModelMapper;

@Service
public class PollingAppService {
	 ...
	 @Autowired
	    ...
	    private static final Logger logger = LoggerFactory.getLogger(PollingAppService.class);
